    ...
    <main style={{ backgroundColor: 'var(--crema)', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          .grid-historia { grid-template-columns: 1fr !important; gap: 3rem !important; }
          .hero-title { font-size: 3rem !important; }
          .seccion-padding { padding: 5rem 5% !important; }
          .img-vivero { height: 450px !important; }
      ...
      <section className="seccion-padding" style={{ padding: '10rem 10%', maxWidth: '1300px', margin: '0 auto' }}>
        <div className="grid-historia" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '8rem', alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div className="floater-box" style={{
              ...
              <p style={{ fontSize: '0.9rem', color: 'var(--verde-selva)', fontWeight: '600', marginTop: '10px', margin: 0 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#555', fontWeight: '300', marginBottom: '3rem' }}>
              Evolucionamos: de cultivar plantas a cultivar experiencias, creando un espacio donde puedes <strong>alojarte, celebrar o respirar</strong> rodeado de la misma vegetación que hemos visto crecer.
            </p>

            <div className="stats-container" style={{ display: 'flex', gap: '30px', alignItems: 'center' }}>
              <div>
                <h4 style={{ margin: 0, fontSize: '2.5rem', color: 'var(--terracota)', fontFamily: 'var(--serif)' }}>10+</h4>
                <p style={{ margin: 0, fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '2px', color: '#888' }}>Años cultivando</p>
              </div>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '2px', color: '#888' }}>Orgánico</p>
              </div>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem' }}>
            <div style={{ padding: '1rem' }}>
              ...
              <p style={{ opacity: 0.8, lineHeight: '1.7', fontSize: '0.95rem' }}>Cuatro suites diseñadas para el descanso profundo, donde el único ruido es el del agua y las aves.</p>
            </div>
            <div style={{ padding: '1rem' }}>
              ...
              <p style={{ opacity: 0.8, lineHeight: '1.7', fontSize: '0.95rem' }}>Bodas, retiros y encuentros que buscan la magia de lo natural en plena ciudad.</p>
            </div>
            <div style={{ padding: '1rem' }}>
              ...
              <p style={{ opacity: 0.8, lineHeight: '1.7', fontSize: '0.95rem' }}>Espacios abiertos para caminar, aprender del vivero y reconectar con la esencia.</p>
            </div>
          </div>
        </div>
      </section>
